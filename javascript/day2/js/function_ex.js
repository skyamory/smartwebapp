...
var result="calculate1() :"+num1+op+num2+"="+calculate1(num1,num2,op)+"\n";
result+="calculate2() :"+num1+op+num2+"="+calculate2(num1,num2,op)+"\n";
result+="calculate3() :"+num1+op+num2+"="+calculate3(num1,num2,op)+"\n";
alert(result);
